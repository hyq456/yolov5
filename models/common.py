...
class MHSABottleneck(nn.Module):  # Conv 是V5作者封装的 conv2d+bn+reulu/silu, 大家可以自己修改，按照算法这个设计思路是一样的
    #https://blog.csdn.net/weixin_44119362/article/details/116785798
    def __init__(self, c1, c2, stride=1, heads=4,  resolution=None, expansion=4):
...
class C3Bot(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)
        self.m = MHSABottleneck(c_, c_, 4, n)
